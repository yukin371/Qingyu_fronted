...
test.describe('书城功能测试', () => {
  ...
  test('访客可以浏览书籍列表', async ({ page }) => {
    ...
    await ScenarioBuilder.create('访客浏览书籍列表')
      .step((builder) =>
        builder
          ...
          .addCustomStep(async () => {
            ...
            const pageTitle = page
              .locator('[data-testid="browse-books-view"] h1.page-title')
              .or(page.locator('text=探索书库'))
            ...
            const bookGrid = page
              .locator('[data-testid="book-grid"]')
              .or(page.locator('.books-layout'))
              .first()
  ...
  test('访客可以查看书籍详情', async ({ page }) => {
    ...
    await ScenarioBuilder.create('访客查看书籍详情')
      .step((builder) =>
        builder
          .addNavigationStep(`/bookstore/browse`, page)
          .addCustomStep(async () => {
  ...
  test('访客可以搜索书籍', async ({ page }) => {
    await ScenarioBuilder.create('访客搜索书籍')
      .step((builder) =>
        builder
          .addNavigationStep('/bookstore/browse', page)
          .addCustomStep(async () => {
            ...
            const pageTitle = page
              ...
              .or(page.locator('[data-testid="browse-books-view"]'))
              .first()
          ...
          .addCustomStep(async () => {
            ...
            const searchInput = page
              ...
              .or(page.locator('textbox[placeholder*="搜索"]'))
  ...
  test('访客可以使用分类筛选', async ({ page }) => {
    await ScenarioBuilder.create('访客使用分类筛选')
      .step((builder) =>
        builder
          .addNavigationStep('/bookstore/browse', page)
          .addCustomStep(async () => {
...
test.describe('用户认证流程测试', () => {
  ...
  test('用户可以注册新账号', async ({ page }) => {
    ...
    await ScenarioBuilder.create('用户注册')
      .step(
        (builder) =>
          builder
            ...
            .addCustomStep(async () => {
              ...
              // 关闭可能存在的 onboarding 弹窗 - 尝试多种方式
              try {
                // 方式1: 按 Escape 键关闭
                await page.keyboard.press('Escape')
                await page.waitForTimeout(200)
                // 方式2: 点击跳过按钮（onboarding 有跳过按钮）
              ...
              // 使用正确的选择器 - AuthenticationView 使用 .mode-btn 按钮而非 tabs
              const registerTab = page.locator('.mode-btn:has-text("注册")')
            ...
            .addCustomStep(async () => {
              ...
              const usernameInput = page
                ...
                .or(page.locator('input[placeholder*="设置用户名"]'))
                .or(page.locator('textbox[placeholder*="用户名"]'))
            ...
            .addCustomStep(async () => {
              ...
              const emailInput = page
                ...
                .or(page.locator('textbox[placeholder*="电子邮箱"]'))
            ...
            .addCustomStep(async () => {
              ...
              const passwordInput = page
                ...
                .or(page.locator('input[placeholder*="设置密码"]'))
                .or(page.locator('textbox[placeholder*="设置密码"]'))
            ...
            .addCustomStep(async () => {
              ...
              const confirmPasswordInput = page
                .locator('[data-testid="register-confirm-password-input"]')
                .or(page.locator('input[placeholder*="确认密码"]'))
                .or(page.locator('textbox[placeholder*="确认密码"]'))
            ...
            .addCustomStep(async () => {
              ...
              const agreementLabel = page
                .locator('label')
                .filter({ hasText: '我已阅读并同意' })
                .or(page.locator('[data-testid="register-agreement-checkbox"]'))
                .or(page.locator('.qy-checkbox, label:has(input[type="checkbox"])'))
            ...
            .addCustomStep(async () => {
              ...
              const registerBtn = page
                .locator('[data-testid="register-submit"]')
                .or(page.locator('button:has-text("注册账号")'))
  ...
  test('用户可以登录', async ({ page }) => {
    ...
    await ScenarioBuilder.create('用户登录')
      .step(
        (builder) =>
          builder
            .addNavigationStep('/login', page)
            .addCustomStep(async () => {
              ...
              // 使用正确的选择器 - AuthenticationView 使用 .mode-btn 按钮而非 tabs
              const loginTab = page.locator('.mode-btn:has-text("登录")')
            ...
            .addCustomStep(async () => {
              ...
              const usernameInput = page
                ...
                .or(page.locator('input[placeholder*="用户名或邮箱"]'))
                .or(page.locator('input[placeholder*="用户名"], input[placeholder*="邮箱"]'))
...
test.describe('阅读器功能测试', () => {
  ...
  test('用户可以阅读书籍章节', async ({ page }) => {
    ...
    await ScenarioBuilder.create('用户阅读章节')
      .step((builder) =>
        builder
          .addNavigationStep(`/bookstore/browse`, page)
          .addCustomStep(async () => {
          ...
          .addCustomStep(async () => {
            // 点击第一本书的书籍卡片进入详情页
            // 由于移动端hover-overlay隐藏，使用点击卡片本身的方式
          ...
          .addCustomStep(async () => {
            ...
            if (!isReaderPage) {
              // 如果在书籍详情页，点击开始阅读按钮
              // 使用 data-testid 或正确文本
              const startReadingBtn = page.locator(
                '[data-testid="start-reading"], [data-testid="continue-reading"], button:has-text("立即阅读"), button:has-text("继续阅读")',
              )
