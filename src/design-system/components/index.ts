...
export { default as QyBadge, default as Badge } from './basic/QyBadge'
export { default as QyAvatar, default as Avatar } from './basic/QyAvatar'
export { default as QyIcon, default as Icon } from './basic/QyIcon'
export { default as QyTag, default as Tag } from './basic/QyTag'
export { default as QyCheckbox, default as Checkbox } from './basic/QyCheckbox'
export { QyCheckboxGroup, default as CheckboxGroup } from './basic/QyCheckbox'
export { default as QyRadio, default as Radio } from './basic/QyRadio'
export { QyRadioGroup, default as RadioGroup } from './basic/QyRadio'
export { default as QySwitch, default as Switch } from './basic/QySwitch'
export { default as QySlider, default as Slider } from './basic/QySlider'
export { default as QyTextarea, default as Textarea } from './basic/QyTextarea'
export { default as QySelect, default as Select } from './basic/QySelect'
export { default as QyRate, default as Rate } from './basic/QyRate'
export { default as QyScrollbar, default as Scrollbar } from './basic/QyScrollbar'
export { default as QyImage, default as Image } from './basic/QyImage'
