<template>
    <div class="main-layout">
        ...
        <!-- 快捷登录对话框 -->
        <el-dialog v-model="showQuickLogin" title="登录" width="400px" :close-on-click-modal="false">
            <el-form :model="quickLoginForm" :rules="quickLoginRules" ref="quickLoginFormRef">
                ...
                <el-form-item prop="password">
                    <el-input v-model="quickLoginForm.password" type="password" placeholder="密码" size="large"
                        show-password @keyup.enter="handleQuickLogin">
                        <template #prefix>
                            <el-icon>
                                <Lock />
                            </el-icon>
