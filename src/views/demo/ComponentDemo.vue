...
const books = ref<Book[]>([
  { id: 1, title: '三体', author: '刘慈欣', status: 'published', words: 350000, revenue: 128000, updateTime: '2024-03-15' },
  { id: 2, title: '活着', author: '余华', status: 'published', words: 85000, revenue: 89000, updateTime: '2024-03-14' },
  { id: 3, title: '解忧杂货店', author: '东野圭吾', status: 'serializing', words: 156000, revenue: 65000, updateTime: '2024-03-16' },
  { id: 4, title: '百年孤独', author: '马尔克斯', status: 'published', words: 268000, revenue: 52000, updateTime: '2024-03-12' },
  { id: 5, title: '恶意', author: '东野圭吾', status: 'draft', words: 98000, revenue: 0, updateTime: '2024-03-10' },
  { id: 6, title: '白夜行', author: '东野圭吾', status: 'published', words: 285000, revenue: 156000, updateTime: '2024-03-15' },
  { id: 7, title: '嫌疑人X的献身', author: '东野圭吾', status: 'published', words: 168000, revenue: 78000, updateTime: '2024-03-14' },
])
    ...
    <div class="max-w-6xl mx-auto space-y-10">
      ...
      <section class="space-y-4">
        <div class="flex items-center gap-3">
          ...
          <span class="px-2 py-0.5 bg-blue-100 text-blue-600 text-xs font-medium rounded-full">数据展示</span>
        </div>
      ...
      <section class="space-y-4">
        <div class="flex items-center gap-3">
          ...
          <span class="px-2 py-0.5 bg-purple-100 text-purple-600 text-xs font-medium rounded-full">加载占位</span>
        </div>
        ...
        <div :class="cardBase + ' p-6'">
          ...
          <div class="space-y-4">
            ...
            <template v-else>
              <div v-for="item in skeletonItems" :key="item" class="flex gap-4 items-center p-3 bg-slate-50 rounded-xl">
                <div class="w-16 h-16 bg-gradient-to-br from-blue-400 to-purple-500 rounded-xl flex items-center justify-center text-white font-bold">
                  {{ item }}
                </div>
                <div>
      ...
      <section class="space-y-4">
        <div class="flex items-center gap-3">
          ...
          <span class="px-2 py-0.5 bg-green-100 text-green-600 text-xs font-medium rounded-full">内容切换</span>
        </div>
          ...
          <div class="space-y-10">
            ...
            <div>
              <p class="text-sm text-slate-500 mb-3">
                <span class="font-medium text-slate-700">line 类型</span> — 底部线条指示器，最简洁的风格
              </p>
              ...
              <Tabs v-model="cardTab" type="card">
                <TabPane name="info" title="基本信息">
                  <div class="py-4 space-y-3">
                    <div class="flex items-center gap-3">
                      <div class="w-12 h-12 rounded-full bg-gradient-to-br from-blue-400 to-purple-500 flex items-center justify-center text-white font-bold">U</div>
                      <div>
            ...
            <div>
              <p class="text-sm text-slate-500 mb-3">
                <span class="font-medium text-slate-700">border-card 类型</span> — 边框卡片，带阴影的整块面板
              </p>
                ...
                <TabPane name="security" title="安全">
                  <div class="py-4 space-y-4">
                    <div class="flex items-center justify-between">
                      ...
                      <button class="px-3 py-1.5 text-sm font-medium text-blue-600 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors">修改</button>
                    </div>
                    <div class="flex items-center justify-between">
                      <div>
                      ...
                      <button class="px-3 py-1.5 text-sm font-medium text-green-600 bg-green-50 hover:bg-green-100 rounded-lg transition-colors">开启</button>
                    </div>
                  </div>
                </TabPane>
              </Tabs>
      ...
      <section class="space-y-4">
        <div class="flex items-center gap-3">
          ...
          <span class="px-2 py-0.5 bg-orange-100 text-orange-600 text-xs font-medium rounded-full">数据导航</span>
        </div>
      ...
      <section class="space-y-4">
        <div class="flex items-center gap-3">
          ...
          <span class="px-2 py-0.5 bg-gray-100 text-gray-600 text-xs font-medium rounded-full">占位提示</span>
        </div>
