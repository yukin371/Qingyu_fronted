...
/**
 * 收藏 API 接口 (v1.0)
 * 对接后端: /api/v1/reader/collections
 */
export const collectionsAPI = {
  ...
  async addCollection(
    ...
    return httpService.post<APIResponse<Collection>>('/reader/collections', {
      book_id: bookId,
      ...data
    })
  },
  ...
  async getCollections(params?: {
    ...
    return httpService.get<PaginatedResponse<Collection>>('/reader/collections', { params })
  },
  ...
  async updateCollection(
    ...
    return httpService.put<APIResponse<Collection>>(`/reader/collections/${id}`, data)
  },
  ...
  async deleteCollection(id: string): Promise<APIResponse<void>> {
    return httpService.delete<APIResponse<void>>(`/reader/collections/${id}`)
  },
  ...
  async checkCollected(bookId: string): Promise<APIResponse<{ collected: boolean }>> {
    return httpService.get<APIResponse<{ collected: boolean }>>(
      `/reader/collections/check/${bookId}`
    )
  },
  ...
  async getCollectionsByTag(tag: string): Promise<APIResponse<Collection[]>> {
    return httpService.get<APIResponse<Collection[]>>(`/reader/collections/tags/${tag}`)
  },
  ...
  async getCollectionStats(): Promise<APIResponse<CollectionStats>> {
    return httpService.get<APIResponse<CollectionStats>>('/reader/collections/stats')
  },
  ...
  async unshareCollection(id: string): Promise<APIResponse<void>> {
    return httpService.delete<APIResponse<void>>(`/reader/collections/${id}/share`)
  },
  ...
  async createFolder(
    ...
    return httpService.post<APIResponse<CollectionFolder>>('/reader/collections/folders', {
      name,
      description
    })
  },
  ...
  async getFolders(): Promise<APIResponse<CollectionFolder[]>> {
    return httpService.get<APIResponse<CollectionFolder[]>>('/reader/collections/folders')
  },
  ...
  async deleteFolder(id: string): Promise<APIResponse<void>> {
    return httpService.delete<APIResponse<void>>(`/reader/collections/folders/${id}`)
  }
}
